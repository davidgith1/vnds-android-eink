...
public class VnImporterEngineMarkerTest {
    ...
    private void seedNsResumeSlot(String vnKey) throws IOException {
        ...
        io.github.davidgith1.vndsandroideink.nscripter.NsScriptEngine engine =
                new io.github.davidgith1.vndsandroideink.nscripter.NsScriptEngine(scratchDir, new NoOpListener(), new java.util.HashMap<>());
        engine.start();
        NsSaveManager.save(context, vnKey, SaveManager.SLOT_RESUME, engine, null,
                io.github.davidgith1.vndsandroideink.engine.VnEngine.SpriteTransparency.OPAQUE, 1, null,
    ...
    private static final class NoOpListener implements io.github.davidgith1.vndsandroideink.engine.VnEngine.Listener {
        @Override
        ...
        public void onBackground(File imageFile, int fadeFrames,
                                  io.github.davidgith1.vndsandroideink.engine.VnEngine.SpriteTransparency transparency,
                                  int alphaMaskCells) {
        }
